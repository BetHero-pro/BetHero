...
const DISCORD_PROD_LINK =
  "https://discord.com/api/oauth2/authorize?client_id=1110861504535871568&redirect_uri=https%3A%2F%2Fbespoke-mousse-8cec1b.netlify.app%2Fauthenticating&response_type=code&scope=identify%20email";
const DISCORD_LOCAL_URI = "http://localhost:3000/authenticating";
const DISCORD_PROD_URI =
  "https://bespoke-mousse-8cec1b.netlify.app/authenticating";
const ENV = "prod";
